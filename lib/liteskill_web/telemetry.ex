defmodule LiteskillWeb.Telemetry do
  @moduledoc false
  use Supervisor
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("liteskill.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("liteskill.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("liteskill.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("liteskill.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("liteskill.repo.query.idle_time",
        unit: {:native, :millisecond},
